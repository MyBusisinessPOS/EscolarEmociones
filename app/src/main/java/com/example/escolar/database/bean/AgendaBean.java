...
public class AgendaBean extends Bean{
    ...
    @Generated(hash = 160473132)
    private transient AgendaBeanDao myDao;
    @Generated(hash = 1153310729)
    public AgendaBean(Long id, Long idUsuario, String fecha, String descricion) {
        this.id = id;
        this.idUsuario = idUsuario;
        this.fecha = fecha;
        this.descricion = descricion;
    }
    @Generated(hash = 1764401597)
    public AgendaBean() {
    }
    public Long getId() {
        return this.id;
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 948005206)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getAgendaBeanDao() : null;
    }
}
